...
\begin{multline}
 H_{C1} = \sum_{r=1}^{N} \sum_{c=1}^{N-2} H_{consec}(x_{r,c}, x_{r,c+1}, x_{r,c+2}) \\
 + \sum_{c=1}^{N} \sum_{r=1}^{N-2} H_{consec}(x_{r,c}, x_{r+1,c}, x_{r+2,c})
\end{multline}
...
\hline
\textbf{Grid} & \textbf{Primary ($N^2$)} & \textbf{Aux (Base)} & \textbf{Aux (w/ Uniq.)} \\
\hline
$4 \times 4$ & 16 & 16 & 196 \\
$6 \times 6$ & 36 & 48 & 738 \\
...
\begin{table}[h]
\centering
\caption{QAOA on $4 \times 4$ Takuzu (16 qubits, 3 trials/depth)}
\footnotesize
\begin{tabular}{|c|c|c|c|c|}
\hline
$p$ & Best $\langle H \rangle$ & Mean $\langle H \rangle$ & Valid & Time (s) \\
\hline
1 & 46.22 & 48.75 & 3/3 & 21.97 \\
2 & 46.64 & 50.53 & 3/3 & 40.33 \\
3 & 52.59 & 53.23 & 3/3 & 43.87 \\
\hline
\end{tabular}
...
\begin{table}[h]
\centering
\caption{QAOA vs.\ RC2 SAT on $4 \times 4$ Takuzu}
\footnotesize
\begin{tabular}{|l|c|c|c|}
\hline
\textbf{Method} & \textbf{Vars} & \textbf{Time} & \textbf{Valid} \\
\hline
QAOA $p\!=\!1$ & 16 qb & 21.97\,s & Yes \\
QAOA $p\!=\!2$ & 16 qb & 40.33\,s & Yes \\
QAOA $p\!=\!3$ & 16 qb & 43.87\,s & Yes \\
...
Future work includes extending the analysis to partially filled grids (the decision variant), where certain cells are pre-assigned and the task is to determine whether a valid completion exists. This would allow direct evaluation of QAOA on the NP-complete form of the problem rather than the enumeration variant studied here.
